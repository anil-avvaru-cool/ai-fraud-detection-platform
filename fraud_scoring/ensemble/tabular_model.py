...
CLAIM_FRAUD_FEATURE_COLS: list[str] = [
    ...
    "risk_score_at_issuance",          # underwriting → claims spine (DEC-010)
...
def train(claims_path: Path, quotes_path: Path, output_dir: Path) -> dict:
    """Train XGBoost fraud model. Returns metrics: auc, gini, log_loss, average_precision."""
    ...
    # Prevents graph_hop_distance from leaking into test metrics.
